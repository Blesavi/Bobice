	...
	<div id="main">
		<div class="section section-bg-9 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">Plantažno gajenje</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section pt-10 pb-5">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="text-center section-title mtn-2">FORMIRANJE PLANTAŽE GODŽIJA</h2>
				...
				<div class="row">
					<div class="col-sm-12">
						<ul>
							<li>&#9679; Zemlju pre sadnje treba izorati i dobro izrotofrezirati (usitniti), nakon čega se buše jame dubine do 40 cm, pobijaju se stubovi i žice i pristupa sadnji.</li>
							<li>&#9679; Razmak između sadnica je 1 – 1.2 m, a između redova 2 – 2.2m. Razmak između stubova 7-8m.</li>
							<li>&#9679; Na 1 hektaru sadi se oko 5000 sadnica. <br> <br> </li>
						</ul>
						<strong>Za plantažu su potrebni:</strong>
						<ul>
							<li>- sistem za navodnjavanje ''kap po kap''</li>
							<li>- konstrukcija sa folijom ili protivgradnom mrežom (za crni godži)</li>
							<li>- stubovi i pocinkovane žice u tri nivoa (špalir)</li>
							<li>- kopče (vezice) za privezivanje stabla i lastara dok je mlada biljka</li>
							<li>- bela divlja detelina koja se zatravi između redova</li>
						</ul>

						<p style="text-align: justify">
							<strong>Celokupnu edukaciju i sve detalje sa skicama oko plantaže crnog godžija dobijate od naše firme prilikom potpisivanja ugovora o kooperaciji.</strong>
						</p>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-offset-1 col-sm-10 pt-3">
						<div class="text-center">
							<img src="{{ asset('web/images/cultivation/formiranje_spalira_goji_bobica.jpg') }}" alt="">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<p>&#9679; Cveta i rađa od maja do novembra meseca, što znači da bobice sukcesivno zru i berba je konstantna. Crni godži se isključivo bere pincetom zbog curenja soka iz bobica.</p>
				...
				<div class="row">
					<div class="col-sm-offset-1 col-sm-10 pb-5 pt-4">
						<div class="text-center">
