	...
	<div id="main">
		<div class="section section-bg-10 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">Sadnica - bordo (žuti) godži</h2>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<ul class="breadcrumbs">
							...
							<li>Sadnica - bordo (žuti) godži</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-9 col-md-push-3">
						<div class="single-product">
									...
									<div class="image-gallery-inner">
										<div>
											<div class="image-thumb">
												<a href="{{ asset('web/images/products/seedling_3/01.jpg') }}" data-rel="prettyPhoto[gallery]">
													<img src="{{ asset('web/images/products/seedling_3/01.jpg') }}" alt="" />
												</a>
											</div>
										</div>
										<div>
											<div class="image-thumb">
												<a href="{{ asset('web/images/products/seedling_3/02.jpg') }}" data-rel="prettyPhoto[gallery]">
													<img src="{{ asset('web/images/products/seedling_3/02.jpg') }}" alt="" />
												</a>
											</div>
										</div>
										<div>
											<div class="image-thumb">
												<a href="{{ asset('web/images/products/seedling_3/03.jpg') }}" data-rel="prettyPhoto[gallery]">
													<img src="{{ asset('web/images/products/seedling_3/03.jpg') }}" alt="" />
												</a>
											</div>
										</div>
									</div>
							...
							<div class="col-md-6">
								<div class="summary">
									<h1 class="product-title">Sadnica - bordo (žuti) godži</h1>
					...
					@include('web.products.allSideMenu', ['product' => 'seedling3'])
				</div>
			</div>
		</div>
	</div>
